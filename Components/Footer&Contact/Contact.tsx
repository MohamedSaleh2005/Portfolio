...
export default function Contact() {
    return (
        <form className="flex flex-col gap-4 py-30  " id="Contact">
            ...
            <div className="m-auto flex flex-col gap-4">
                <input type="text" placeholder="Full Name" className="Special Contact MyShadow w-85" />
                <textarea placeholder="Write Your Massege" className="Special Contact MyShadow h-50 resize-none"></textarea>
            </div>
        </form>
    )
}
