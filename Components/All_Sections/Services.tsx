    ...
    return (
        <section className='flex flex-col py-25 md:py-40' id='Services'>
            ...
            <div className='  md:px-30 my-10  grid md:grid-cols-3 place-items-center gap-8'>
                ...
                {cards.map((card) => (
                    <div key={card.id} className='Special w-65  shadow-sky-700 shadow-[1px_5px_5px_1px] hover:shadow-[0_3px_25px_-] p-5 rounded-xl border-sky-400 border-2 flex flex-col items-center'>
